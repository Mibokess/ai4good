...
fig.tight_layout()
plt.show()
fig.savefig('Test-Label.png', format='png', transparent=True,dpi=500, bbox_inches='tight', pad_inches=0)

# TODO try to get google earth engine to export area

# Do the thing with GEE - cant get this shit to work. rip
