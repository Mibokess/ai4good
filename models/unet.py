...
class Unet(nn.Module):
    def __init__(self, in_channels):
        ...
        self.skip1 = DoubleConv(in_channels, 64)
        self.skip2 = DoubleConv(64, 128)
        self.skip3 = DoubleConv(128, 256)
        self.skip4 = DoubleConv(256, 512)
        self.last_conv = DoubleConv(512, 1024)

        self.pool = nn.MaxPool2d(2, stride=2)

        self.up4 = nn.ConvTranspose2d(1024, 512, 2, stride=2)
        self.cat_double_conv4 = DoubleConv(1024, 512)
        self.up3 = nn.ConvTranspose2d(512, 256, 2, stride=2)
        self.cat_double_conv3 = DoubleConv(512, 256)
        self.up2 = nn.ConvTranspose2d(256, 128, 2, stride=2)
        self.cat_double_conv2 = DoubleConv(256, 128)
        self.up1 = nn.ConvTranspose2d(128, 64, 2, stride=2)
        self.cat_double_conv1 = DoubleConv(128, 64)
