...
def command_line_parser():
    ...
    parser.add_argument(
        "--project",
        type=str,
        default="Land Use Mapping - Pseudo Test",
    ...
    # -------------------------- training settings --------------------------
    parser.add_argument(
        "--num_epochs_seg", type=int, default=50, help="Number of training epochs"
    )
    parser.add_argument(
        "--batch_size",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to cycleGAN ckpt file.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to seg net ckpt file.",
    )
